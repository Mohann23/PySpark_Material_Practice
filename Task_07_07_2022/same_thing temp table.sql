...
select no_name_table.supplier_name,no_name_table.region,no_name_table.supplier_id,
no_name_table.product_id,
no_name_table.date, 
no_name_table.Quantity   
from(
...
group by temp_table.date) no_name_table 
